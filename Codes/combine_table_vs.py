...
def get_VTASN_combined(group):
	#Reading harmonized VTASN data and combining them to use as a test dataset.

	vtasn_file_list = glob.glob("../Data/combat/all/testdata_VTASN/"+group+'/*168*'+'.csv') #finding all the csv files for CT
	...
	ppmi_file_list = glob.glob("../Data/combat/all/train_PPMI_with_VTASN/"+group+'/*168*'+'.csv') #finding all the csv files for CT
	ppmi_file_list.sort()
...
#combine_with_UPDRS()
get_VTASN_combined("CT")
get_VTASN_combined("PD")
