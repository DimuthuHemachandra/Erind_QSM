...
function data_harmonized = get_harmonized(group_path)
    ...
    dinfo = dir(strcat(group_path,'Baseline_with_VTASN/*.csv')); %Reading paths to csv files generated by combat.py
	...
	for i=1:n
        ...
        M=readtable(strcat(group_path,'Baseline_with_VTASN/',filenames{i})); %Reading csv files
        ...
        writetable(M,strcat(group_path,'combat_BL_with_VTASN/',filenames{i}),'Delimiter',',')  
